...
# strona wyswietlana
class Logowanie(UserControl):
    def __init__(self, page):
        super().__init__()
        self.page = page


    def main(page: Page,self):
        page.title = "logowanie"
        page.vertical_alignment = ft.MainAxisAlignment.CENTER
        page.add(ft.ElevatedButton(text="Zarejestruj się",  on_click= lambda : self.page.go('/zoabcz') ))
        # logowanie tego typu
        def zaloguj_page():
            page.clean()
            page.update()
        ...
        def page_rejestracja(e):
            ...
            page.add(ft.ElevatedButton(text="Powrót do logowania", ))
